...
*/
  ...
  // SPI should not be overclocked - works up to 27MHz
  ...
  #define TFT_CS  5
/*
  // These are the pins used for Olimex' ESP32-S2-DevKit-Lipo (S2 WROOM - single core) board
//  #define TFT_MOSI 35
//  #define TFT_MISO 37
//  #define TFT_CLK  36
  // flexible SPI independent
...
*/
  ...
  // SPI could be overclocked up to 62.5MHz, CPU Speed up to 250MHz 
  // and https://github.com/Bodmer/TFT_eSPI/issues/1460#issuecomment-1006661452
  // These are the pins used for RP Pi PicoW RP2040 and spi0 board
  #define TFT_MOSI 19
  #define TFT_MISO 16
  #define TFT_CLK  18
  // flexible SPI independent
...
// set SPI_FREQUENCY  27000000 in eSPI User_Setup.h eSPI to work !!!!!!!!!!!!!!!!!!!
